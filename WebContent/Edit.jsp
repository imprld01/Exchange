		...
		<div class="content">
			...
			<div class="information clearfix">
				...
				<div class="info_area info_left info_content">
                    ...
                    <textarea cols="50" rows="20" name="intorExpr" placehoder = "輸入技能簡介及經歷..." required>${skill.intorExpr}</textarea>
					...
					<ul>
						<c:forEach var="video" items="${skill.video}">
                         ...
                         <br>輸入連結以嵌入影片 <input type="text"  > <img src="images/plus.png" style="margin-top:2px;"><br>
                        ...
                        <br>輸入連結以嵌入圖片 <input type="text"  > <img src="images/plus.png" style="margin-top:2px;"><br>
					</ul>
                   </form> 
				</div>
